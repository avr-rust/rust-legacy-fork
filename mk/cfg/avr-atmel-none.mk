...
CFG_GCCISH_CFLAGS_avr-atmel-none := -Wall -g -fPIC -mmcu=atmega328p $(CFLAGS)
CFG_GCCISH_CXXFLAGS_avr-atmel-none := -fno-rtti $(CXXFLAGS)
CFG_GCCISH_LINK_FLAGS_avr-atmel-none := -shared -fPIC -g -mmcu=atmega328p
...
RUSTC_FLAGS_avr-atmel-none := -C target-cpu=atmega328p -C target-feature="+atmega328p"
